...
### 💻 Perfil Profissional
- **Educação:** Graduação em Análise e Desenvolvimento de Sistemas (5º Semestre).
- **Atuação:** Técnico de Suporte e Help Desk, com experiência em Troubleshooting e suporte a utilizadores de sistemas ERP.
- **Foco:** Desenvolvedor Java - Carreira Java na Alura (Em andamento)
